...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    &nbsp;:
                     <asp:FileUpload ID="FU1" runat="server" Width="175px" />
    &nbsp;
    <p />
    <asp:Image ID="imgPhoto" runat="server" Height="150px" Width="250px" ImageUrl='<%# string.Format("~/photo/{0}", Eval("ShopList.aspx")) %>'></asp:Image>
