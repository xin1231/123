<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ShopDel.aspx.cs" Inherits="HeyOrder.ShopDel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        &nbsp;:
            <asp:Image ID="Img1" runat="server" Height="150px" ImageUrl="~/ShopList.aspx" Width="250px" />
        <p />
