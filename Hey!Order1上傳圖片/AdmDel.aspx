<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AdmDel.aspx.cs" Inherits="HeyOrder.AdmDel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <p />
        <asp:Label ID="Label6" runat="server" Text="啟用"></asp:Label>
        &nbsp;:
            <asp:TextBox ID="txttbFbkFlg" runat="server"></asp:TextBox>

        <p />
        <asp:Label ID="Label7" runat="server" Text="建檔時間"></asp:Label>
        &nbsp;:
            <asp:TextBox ID="txttbFbkCdt" runat="server"></asp:TextBox>
