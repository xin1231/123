<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeDel.aspx.cs" Inherits="HeyOrder.MeDel" %>
...
<body>
    <form id="form1" runat="server">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnOk" runat="server" OnClick="btnOk_Click" OnClientClick="return confirm('確定要刪除嗎???')" Text="確定刪除" />
    </form>
</body>
</html>
