<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DeAdd.aspx.cs" Inherits="HeyOrder.DeAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div>
            ...
            <asp:Button ID="btncel" runat="server" OnClick="btncel_Click" Text="取消" Style="height: 27px" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
