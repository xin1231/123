        ...
        protected void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection())
                {
                    ...
                    cn.Open();
                    sqlString = "INSERT INTO Admin (tbAdmNO, tbAdmUid, tbAdmPwd, tbAdmNot, tbFbkFlg, tbFbkCdt) ";
                    sqlString += " Values(@tbANO, @tbAUid, @tbAPwd, @tbANot, @tbFFlg, @tbFCdt)";
                    ...
                    cmd.Parameters.AddWithValue("@tbFFlg", txttbFbkFlg.Text);
                    cmd.Parameters.AddWithValue("@tbFCdt", txttbFbkCdt.Text);
                    cmd.ExecuteNonQuery();
                    cn.Close();
