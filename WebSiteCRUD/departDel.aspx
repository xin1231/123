<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="departDel.aspx.cs" Inherits="WebForm1.departDel" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="lbTitle" runat="server" Text="刪除資料"></asp:Label>
            <br />
            <asp:Label ID="lbTitle0" runat="server" Font-Size="X-Large" Text="刪除資料"></asp:Label>
            <br />
            <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" Text="確定刪除" OnClientClick="return confirm('是否確定刪除?');" />
        </div>
    </form>
</body>
</html>
